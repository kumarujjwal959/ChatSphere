      ...
      <div style="font-family: Arial, sans-serif; line-height: 1.6;">
        <div style="max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px;">
          ...
          <p style="text-align: center;">
            <img src="https://res.cloudinary.com/ujjwal-node/image/upload/v1716641361/Screenshot_2024-05-25_at_6.18.57_PM_rx6xei.png" alt="${process.env.EMAIL_FROM_NAME} Logo" style="width: 200px; margin-bottom: 20px;">
          </p>
          <p>Hello,</p>
